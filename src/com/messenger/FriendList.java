...
{
	private static final int SEE_STRANGER_LIST = Menu.FIRST;
	private static final int ADD_NEW_FRIEND_ID = Menu.FIRST+1;
	private static final int REFRESH_FRIEND_LIST = Menu.FIRST+2;
...
//		menu.add(0, SEE_STRANGER_LIST, 0, R.string.see_stranger_list);
		
		menu.add(0, ADD_NEW_FRIEND_ID, 0, R.string.manage_friend);
		
		menu.add(0, REFRESH_FRIEND_LIST, 0, R.string.refresh_friend_list);
	...
	{		
		...
		/*	case SEE_STRANGER_LIST:
			{
				Intent i = new Intent(FriendList.this, StrangerList.class);
				startActivity(i);
				finish();
				return true;
			}*/
			...
			{
				Intent i = new Intent(FriendList.this, ManageFriend.class);
				startActivity(i);
				return true;
			}
			case REFRESH_FRIEND_LIST:
			{
				imService.refreshFriendList();
				return true;
			}
			case EXIT_APP_ID:
			{
