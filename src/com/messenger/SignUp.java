...
public class SignUp extends Activity {
	...
	private static final int SIGN_UP_STRANGERNAME_CRASHED = 6;
...
//	private static final String SERVER_RES_SIGN_UP_FAILED = "0";
	...
	private static final String SERVER_RES_SIGN_UP_STRANGERNAME_CRASHED = "3";
	...
	public void onCreate(Bundle savedInstanceState) {
	        ...
	        strangerText= (EditText) findViewById(R.id.strangerName);
										...
										public void run() {
											...
											handler.post(new Runnable(){
												...
												public void run() {
													...
													else if (result.equals(SERVER_RES_SIGN_UP_STRANGERNAME_CRASHED)){
														showDialog(SIGN_UP_STRANGERNAME_CRASHED);
													}
	...
	{    	
		...
		switch (id) 
		{
			...
			case SIGN_UP_USERNAME_CRASHED:
				...
				.create();
			case SIGN_UP_STRANGERNAME_CRASHED:
				return new AlertDialog.Builder(SignUp.this)       
				.setMessage(R.string.signup_strangername_crashed)
				.setPositiveButton(R.string.OK, new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int whichButton) {
						/* User clicked OK so do some stuff */
					}
